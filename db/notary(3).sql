...
--
-- Host: localhost
-- Generation Time: Jun 19, 2014 at 04:12 PM
...
(1, 'APHT', 0),
(2, 'Akta Perjanjian Investasi', 0),
(3, 'Akta Perjanjian Pinjaman', 0),
(5, 'Akta Baru', 1);
...
INSERT INTO `aktatran` (`AKTATRANID`, `AKTAID`, `TRANSAKSIPRAID`, `CURRENTPROSES`, `STATUSAKTAID`, `NOAKTA`, `TGLMULAI`, `TGLSELESAI`) VALUES
(1, 1, 1, 1, 1, 'akta/1', '2014-06-20', '2014-08-20');
...
(1, 1, 'Cicendo', 'Covernote/1', '2014-06-16', NULL, NULL, 'kosong', 1, '2014-06-16 09:39:06', '2014-08-16'),
(2, 1, 'Dasdadsa', 'asd', '2014-06-30', NULL, NULL, 'kosong', 1, '2014-06-17 13:00:35', '2014-06-30'),
(3, 1, '', '', '1970-01-01', NULL, NULL, 'kosong', 1, '2014-06-19 13:08:02', '1970-01-01');
...
(1, NULL, NULL, NULL, 1, 'Ronaldo', NULL, '123456');
...
INSERT INTO `employee` (`EMPLOYEEID`, `GENDER`, `IDENTITASPERSONALID`, `TITLEID`, `JABATANID`, `NIP`, `NAMALENGKAP`, `TANGGALLAHIR`, `NOIDENTITASPERSONAL`) VALUES
(1, 1, 1, 1, 8, '000000000', 'Administrator', '2014-03-06', '000000000'),
(2, NULL, 1, NULL, 6, '1', 'Arif', '1995-08-28', '1'),
(3, NULL, 1, NULL, 7, '2', 'Ujang', '1967-08-28', '2'),
(4, NULL, NULL, NULL, 1, '3', 'Baim', '1950-08-28', '');
...
(2, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL),
(3, NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL),
(4, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `proses` (`PROSESID`, `SATWAKTUSTDID`, `PROSESPARENT`, `PROSESDESC`, `DEFWAKTUSTD`, `DEFPICALERT`, `DEFSPVALERT`, `DEFBIAYAPROSES`, `DEFBIAYADROP`, `DEFSATALERT`, `AKTAID`, `NOMORURUT`) VALUES
(1, 3, '0', 'Salinan PBB', '3', '7', '5', '2000000', '2000000', 1, 1, 1),
(2, 3, '0', 'Salinan Sertifikat', '3', '7', '5', '4000000', '5000000', 1, 1, 2),
(3, 3, '0', 'Pemekaran', '1', '7', '3', '1000000', '500000', 1, 2, 1),
(4, 3, '0', 'Roya', '1', '5', '3', '2000000', '200000', 1, 2, 2),
(7, 3, '0', 'Balik Nama', '1', '6', '3', '1000000', '300000', 1, 3, 1);
...
INSERT INTO `prosesakta` (`PROSESID`, `AKTAID`, `NOMORURUT`) VALUES
(1, 1, 2),
(1, 2, 2),
(4, 2, 1),
(7, 1, 1);
...
INSERT INTO `prosesdoc` (`AKTAID`, `TIPEDOKUMENID`) VALUES
(1, 1),
(3, 1),
(1, 2),
(2, 2),
...
INSERT INTO `prosestran` (`PROSESTRANID`, `AKTATRANID`, `PROSESID`, `USERID`, `WAKTUPROSTRAN`, `PICALERTPROSTRAN`, `SPVALERTPROSTRAN`, `BIAYAPROSTRAN`, `BIAYADROPTRAN`, `SATPROSES`, `SATALERT`, `TGLMULAI`, `TGLSELESAI`, `ALERTSPV`, `ALERTPIC`, `STATUSPROSES`) VALUES
(1, 1, 7, NULL, '1', NULL, NULL, NULL, NULL, 3, NULL, '2014-06-20', '2014-07-20', 0, 0, 1),
(2, 1, 1, NULL, '1', NULL, NULL, NULL, NULL, 3, NULL, '2014-07-20', '2014-08-20', 0, 0, 1);
...
INSERT INTO `sertifikat` (`SERTIFIKATID`, `TYPESERTIFIKATID`, `NAMAPENJUAL`, `NAMAPEMILIK`, `NOMOR`, `AKTATRANID`) VALUES
(1, 1, 'Udin', 'Ujang', 'sertifikat/1', 1);
...
(1, 1, 2, 1, NULL, '2014-06-16 09:38:42', NULL, 3, 4, 'Trans/1', 1);
...
ALTER TABLE `aktatran`
  ADD CONSTRAINT `aktatran_ibfk_1` FOREIGN KEY (`AKTAID`) REFERENCES `akta` (`AKTAID`),
  ADD CONSTRAINT `aktatran_ibfk_3` FOREIGN KEY (`STATUSAKTAID`) REFERENCES `statusakta` (`STATUSAKTAID`),
  ADD CONSTRAINT `aktatran_ibfk_4` FOREIGN KEY (`TRANSAKSIPRAID`) REFERENCES `transaksipra` (`TRANSAKSIPRAID`);
...
ALTER TABLE `bankrekening`
  ADD CONSTRAINT `FK_RELATIONSHIP_39` FOREIGN KEY (`BANKUTAMAID`) REFERENCES `bankutama` (`BANKUTAMAID`);
...
ALTER TABLE `contactditail`
  ADD CONSTRAINT `contactditail_ibfk_1` FOREIGN KEY (`EMPLOYEEID`) REFERENCES `employee` (`EMPLOYEEID`);

--
-- Constraints for table `contactditailcustomer`
--
ALTER TABLE `contactditailcustomer`
  ADD CONSTRAINT `contactditailcustomer_ibfk_1` FOREIGN KEY (`CUSTOMERID`) REFERENCES `customer` (`CUSTOMERID`);

--
-- Constraints for table `covernote`
--
ALTER TABLE `covernote`
  ADD CONSTRAINT `covernote_ibfk_1` FOREIGN KEY (`TRANSAKSIPRAID`) REFERENCES `transaksipra` (`TRANSAKSIPRAID`),
  ADD CONSTRAINT `FK_RELATIONSHIP_40` FOREIGN KEY (`TIPEWILAYAHID`) REFERENCES `tipewilayah` (`TIPEWILAYAHID`);

--
-- Constraints for table `customer`
--
ALTER TABLE `customer`
  ADD CONSTRAINT `FK_RELATIONSHIP_12` FOREIGN KEY (`PEKERJAANID`) REFERENCES `pekerjaan` (`PEKERJAANID`),
  ADD CONSTRAINT `FK_RELATIONSHIP_14` FOREIGN KEY (`GENDER`) REFERENCES `gender` (`GENDER`),
  ADD CONSTRAINT `FK_RELATIONSHIP_15` FOREIGN KEY (`IDENTITASPERSONALID`) REFERENCES `identitaspersonal` (`IDENTITASPERSONALID`),
  ADD CONSTRAINT `FK_RELATIONSHIP_16` FOREIGN KEY (`TIPECUSTID`) REFERENCES `tipecustomer` (`TIPECUSTID`);

--
-- Constraints for table `customertrans`
--
ALTER TABLE `customertrans`
  ADD CONSTRAINT `customertrans_ibfk_3` FOREIGN KEY (`CUSTOMERID`) REFERENCES `customer` (`CUSTOMERID`),
  ADD CONSTRAINT `customertrans_ibfk_4` FOREIGN KEY (`TRANSAKSIPRAID`) REFERENCES `transaksipra` (`TRANSAKSIPRAID`);

--
-- Constraints for table `daftarrekening`
--
ALTER TABLE `daftarrekening`
  ADD CONSTRAINT `FK_RELATIONSHIP_41` FOREIGN KEY (`BANKREKID`) REFERENCES `bankrekening` (`BANKREKID`);

--
-- Constraints for table `dokumen`
--
ALTER TABLE `dokumen`
  ADD CONSTRAINT `dokumen_ibfk_1` FOREIGN KEY (`TRANSAKSIPRAID`) REFERENCES `transaksipra` (`TRANSAKSIPRAID`),
  ADD CONSTRAINT `FK_RELATIONSHIP_35` FOREIGN KEY (`TIPEDOKUMENID`) REFERENCES `tipedokumen` (`TIPEDOKUMENID`),
  ADD CONSTRAINT `FK_RELATIONSHIP_42` FOREIGN KEY (`IDSTATUSDOC`) REFERENCES `statusdokumen` (`IDSTATUSDOC`);

--
-- Constraints for table `employee`
--
ALTER TABLE `employee`
  ADD CONSTRAINT `FK_RELATIONSHIP_1` FOREIGN KEY (`GENDER`) REFERENCES `gender` (`GENDER`),
  ADD CONSTRAINT `FK_RELATIONSHIP_11` FOREIGN KEY (`JABATANID`) REFERENCES `jabatan` (`JABATANID`),
  ADD CONSTRAINT `FK_RELATIONSHIP_2` FOREIGN KEY (`IDENTITASPERSONALID`) REFERENCES `identitaspersonal` (`IDENTITASPERSONALID`),
  ADD CONSTRAINT `FK_RELATIONSHIP_3` FOREIGN KEY (`TITLEID`) REFERENCES `title` (`TITLEID`);

--
-- Constraints for table `eskalasi`
--
ALTER TABLE `eskalasi`
  ADD CONSTRAINT `eskalasi_ibfk_3` FOREIGN KEY (`AKTATRANID`) REFERENCES `aktatran` (`AKTATRANID`),
  ADD CONSTRAINT `eskalasi_ibfk_4` FOREIGN KEY (`EMPLOYEEID`) REFERENCES `employee` (`EMPLOYEEID`),
  ADD CONSTRAINT `eskalasi_ibfk_5` FOREIGN KEY (`TARGET`) REFERENCES `employee` (`EMPLOYEEID`);

--
-- Constraints for table `foto`
--
ALTER TABLE `foto`
  ADD CONSTRAINT `FK_RELATIONSHIP_5` FOREIGN KEY (`STATUSDISPLAYID`) REFERENCES `statusdisplay` (`STATUSDISPLAYID`),
  ADD CONSTRAINT `foto_ibfk_2` FOREIGN KEY (`EMPLOYEEID`) REFERENCES `employee` (`EMPLOYEEID`);
...
ALTER TABLE `notifikasi`
  ADD CONSTRAINT `notifikasi_ibfk_1` FOREIGN KEY (`EMPLOYEEID`) REFERENCES `employee` (`EMPLOYEEID`);
...
--
ALTER TABLE `proses`
  ADD CONSTRAINT `FK_RELATIONSHIP_24` FOREIGN KEY (`SATWAKTUSTDID`) REFERENCES `satuanwaktustd` (`SATWAKTUSTDID`),
  ADD CONSTRAINT `proses_ibfk_1` FOREIGN KEY (`DEFSATALERT`) REFERENCES `satuanwaktustd` (`SATWAKTUSTDID`),
  ADD CONSTRAINT `proses_ibfk_2` FOREIGN KEY (`AKTAID`) REFERENCES `akta` (`AKTAID`) ON DELETE SET NULL;
...
ALTER TABLE `prosesdoc`
  ADD CONSTRAINT `FK_PROSESDOC2` FOREIGN KEY (`TIPEDOKUMENID`) REFERENCES `tipedokumen` (`TIPEDOKUMENID`),
  ADD CONSTRAINT `prosesdoc_ibfk_1` FOREIGN KEY (`AKTAID`) REFERENCES `akta` (`AKTAID`);

--
-- Constraints for table `prosestran`
--
ALTER TABLE `prosestran`
  ADD CONSTRAINT `FK_RELATIONSHIP_22` FOREIGN KEY (`PROSESID`) REFERENCES `proses` (`PROSESID`),
  ADD CONSTRAINT `prosestran_ibfk_2` FOREIGN KEY (`SATALERT`) REFERENCES `satuanwaktustd` (`SATWAKTUSTDID`),
  ADD CONSTRAINT `prosestran_ibfk_4` FOREIGN KEY (`SATPROSES`) REFERENCES `satuanwaktustd` (`SATWAKTUSTDID`),
  ADD CONSTRAINT `prosestran_ibfk_5` FOREIGN KEY (`STATUSPROSES`) REFERENCES `statusproses` (`STATUSPROSESID`),
  ADD CONSTRAINT `prosestran_ibfk_6` FOREIGN KEY (`USERID`) REFERENCES `user` (`USERID`);

--
-- Constraints for table `sertifikat`
--
ALTER TABLE `sertifikat`
  ADD CONSTRAINT `sertifikat_ibfk_1` FOREIGN KEY (`TYPESERTIFIKATID`) REFERENCES `typesertifikat` (`TYPESERTIFIKATID`),
  ADD CONSTRAINT `sertifikat_ibfk_2` FOREIGN KEY (`AKTATRANID`) REFERENCES `aktatran` (`AKTATRANID`);
...
ALTER TABLE `transaksipra`
  ADD CONSTRAINT `transaksipra_ibfk_10` FOREIGN KEY (`EMPLOYEEID`) REFERENCES `employee` (`EMPLOYEEID`),
  ADD CONSTRAINT `transaksipra_ibfk_11` FOREIGN KEY (`SUPERVISOR`) REFERENCES `employee` (`EMPLOYEEID`),
  ADD CONSTRAINT `transaksipra_ibfk_12` FOREIGN KEY (`NOTARIS`) REFERENCES `employee` (`EMPLOYEEID`),
  ADD CONSTRAINT `transaksipra_ibfk_3` FOREIGN KEY (`STATUSPJKID`) REFERENCES `statuspajak` (`STATUSPJKID`),
  ADD CONSTRAINT `transaksipra_ibfk_4` FOREIGN KEY (`STATUSBYR`) REFERENCES `statusbayar` (`STATUSBYR`),
  ADD CONSTRAINT `transaksipra_ibfk_5` FOREIGN KEY (`DEVELOPERID`) REFERENCES `developer` (`DEVELOPERID`),
  ADD CONSTRAINT `transaksipra_ibfk_8` FOREIGN KEY (`BANKREKID`) REFERENCES `bankrekening` (`BANKREKID`),
  ADD CONSTRAINT `transaksipra_ibfk_9` FOREIGN KEY (`USERID`) REFERENCES `user` (`USERID`);

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `FK_RELATIONSHIP_8` FOREIGN KEY (`STATUSUSERID`) REFERENCES `statususer` (`STATUSUSERID`),
  ADD CONSTRAINT `FK_RELATIONSHIP_9` FOREIGN KEY (`OTORITASID`) REFERENCES `otoritas` (`OTORITASID`),
