            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data Employee berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="row-fluid">
                                    ...
                                    <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="29%" class="TAC">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            foreach ($list as $row):
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#dModal" role="button" class="button green tip" data-original-title="Edit" data-toggle="modal" onClick="modalToogler('<?= $row->EMPLOYEEID ?>')"><div class="icon"><span class="ico-pencil"></span></div></a>
                                                        <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onClick="modalToogler('<?= $row->EMPLOYEEID ?>')" >
                                                            <div class="icon"><span class="ico-remove"></span></div>
                                                        </a>
                                                        <a href="<?= base_url() ?>master_data/common_master/admin/employee/detail/<?= $row->EMPLOYEEID ?>" class="button purple tip" data-original-title="Detail">
                        ...
                        <div id="dModal" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel">
                            ...
                            <div class="modal-body">
                                <div class="widgets">
                                    <a id="edit" href="<?= $row->EMPLOYEEID ?>" class="swidget blue">
                                        <div class="icon">
                                    ...
                                    <a id="edit_foto" href="" class="swidget blue">
                                        <div class="icon">
...
<script language="javascript">
    ...
    function modalToogler(employeeID)
    {
        document.getElementById('edit').href = '<?= base_url() ?>master_data/common_master/admin/employee/edit/' + employeeID;
        document.getElementById('edit_detail').href = '<?= base_url() ?>master_data/common_master/admin/employee/edit_detail/' + employeeID;
        document.getElementById('edit_foto').href = '<?= base_url() ?>master_data/common_master/admin/employee/edit_detail_foto/' + employeeID;
        document.getElementById('delete').href = '<?= base_url() ?>control/delete/employee/' + employeeID;
