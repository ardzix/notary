                                    ...
                                    <div class="span8">                
                                        ...
                                        <div class="block">
                                            ...
                                            <div class="data-fluid">
                                                <form action="<?= base_url() ?>control/edit/akun_admin" method="post">
                                                    <div class="row-form">

                                                        <div class="span4">Pilih User:</div>
                                                        <div class="span8">                            
                                                            <select class="select" name="USERID" class="validate[required]" style="width: 100%;">
                                                                <option value=""></option>
                                                                <?php
                                                                foreach ($user as $row):
                                                                    ?>
