...
/*
 * Project Name: notary
 * File Name: tipe_customer
 * Created on: 20 Jan 14 - 11:13:42
            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data tipe customer berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data tipe customer berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data tipe customer gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Tipe Customer Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/tipe_customer">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Tipe Customer:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="TIPECUSTDESC" placeholder="Masukan Tipe Customer Baru"/></div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Inisial Customer:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="INISIALTIPECUST" placeholder="Masukan Tipe Inisial Customer"/></div>
                                                    </div>
                                                ...
                                                <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="50%">Tipe Customer</th>
                                                            <th width="30%">Inisial Customer</th>
                                                    ...
                                                    <tbody>
                                                         <?php foreach ($tipecustomer as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row->TIPECUSTDESC ?></td>
                                                                <td><?= $row->INISIALTIPECUST ?></td>
                                                                <td>
                                                                    <!--                                                                <button class="btn tip" data-original-title="Default tip">Default tip</button>-->

                                                                    <a href="<?= base_url() ?>master_data/form_master/tipe_customer/edit/<?= $row->TIPECUSTID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->TIPECUSTID ?>')"> 
...
<script>
    function hapus(tipe_customer) {
        document.getElementById('tipe_customer').href = '<?= base_url() ?>control/delete/delete_tipe_customer/' + tipe_customer;
    }
</script>
</body>
</html>
