...
/*
 * Project Name: notary
 * File Name: status_proses
 * Created on: 20 Jan 14 - 11:08:21
            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status proses berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status proses berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status proses gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Status Proses</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li   class="active"><a href="<?= base_url() ?>master_data/form_master/status_proses">Status Proses</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Status Proses Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/status_proses">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status Proses:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="STATUSDESC" placeholder="Masukan Status Proses Baru"/></div>
                                                    </div>
                                                        ...
                                                        <?php foreach ($statusproses as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="<?= base_url() ?>master_data/form_master/status_proses/edit/<?= $row->STATUSPROSESID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->STATUSPROSESID ?>')"> 
...
<script>
    function hapus(status_proses) {
        document.getElementById('status_proses').href = '<?= base_url() ?>control/delete/delete_status_proses/' + status_proses;
    }
</script>
</body>
</html>
