...
/*
 * Project Name: notary
 * File Name: status_proses_edit
 * Created on: 20 Jan 14 - 11:09:11
            ...
            <div class="body">
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Status Proses ID</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Status Proses</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_status_proses">
                                                <input type="hidden" value="<?= $statusproses['STATUSPROSESID'] ?>" NAME="STATUSPROSESID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status Proses:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="STATUSDESC" value="<?= $statusproses['STATUSDESC'] ?>"/></div>
                                                    </div>
