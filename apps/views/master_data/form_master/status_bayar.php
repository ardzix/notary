...
/*
 * Project Name: notary
 * File Name: status_bayar
 * Created on: 20 Jan 14 - 11:47:48
            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status bayar berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status bayar berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status bayar gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Status Bayar</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li   class="active"><a href="<?= base_url() ?>master_data/form_master/status_bayar">Status Bayar</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Status Bayar Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/status_bayar">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status Bayar:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="STATUSBYRDESC" placeholder="Masukan Satuan Waktu Standard Baru"/></div>
                                                    </div>
                                            ...
                                            <div class="data-fluid">
                                                <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($statusbayar as $row):
                                                            ?>
                                                            <tr>
                                                                <td><input type="checkbox" name="order[]" value="528"/></td>
                                                                <td><?= $row->STATUSBYRDESC ?></td>
                                                                <td>
                                                                    <!--                                                                <button class="btn tip" data-original-title="Default tip">Default tip</button>-->

                                                                    <a href="<?= base_url() ?>master_data/form_master/status_bayar/edit/<?= $row->STATUSBYR ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->STATUSBYR ?>')"> 
...
<script>
    function hapus(status_bayar) {
        document.getElementById('status_bayar').href = '<?= base_url() ?>control/delete/delete_status_bayar/' + status_bayar;
    }
</script>
</body>
</html>
