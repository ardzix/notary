...
/*
 * Project Name: notary
 * File Name: status_display
 * Created on: 20 Jan 14 - 11:06:49
            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status display berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status display berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status display gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Status Display Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/status_display">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status Display:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="STATUSDISPLAYDESC" placeholder="Masukan Status Display Baru"/></div>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($statusdisplay as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row->STATUSDISPLAYDESC ?></td>
                                                                <td>
                                                                    <a href="<?= base_url() ?>master_data/form_master/status_display/edit/<?= $row->STATUSDISPLAYID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->STATUSDISPLAYID ?>')"> 
...
<script>
    function hapus(status_display) {
        document.getElementById('status_display').href = '<?= base_url() ?>control/delete/delete_status_display/' + status_display;
    }
</script>
</body>
</html>
