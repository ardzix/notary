            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status dokumen berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status dokumen berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data status dokumen gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li   class="active"><a href="<?= base_url() ?>master_data/form_master/status_dokumen">Status Dokumen</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Status Dokumen Baru</h2>                                
                                            </div>
                                            <form id="validate"  method="post" action="<?= base_url() ?>control/add/status_dokumen">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status Dokumen:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="STATUS" placeholder="Masukan Status Dokumen Baru"/></div>
                                                    </div>
                                                        ...
                                                        <?php foreach ($statusdokumen as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="<?= base_url() ?>master_data/form_master/status_dokumen/edit/<?= $row->IDSTATUSDOC ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->IDSTATUSDOC ?>')"> 
...
<script>
    function hapus(status_dokumen) {
        document.getElementById('status_dokumen').href = '<?= base_url() ?>control/delete/delete_status_dokumen/' + status_dokumen;
    }
</script>
</body>
</html>
