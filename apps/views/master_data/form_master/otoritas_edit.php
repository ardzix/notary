...
/*
 * Project Name: notary
 * File Name: otoritas_edit
 * Created on: 20 Jan 14 - 11:20:53
                                ...
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_otoritas">
                                                <input type="hidden" value="<?= $otoritas['OTORITASID'] ?>" NAME="OTORITASID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Otoritas:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="OTORITASDESC" value="<?= $otoritas['OTORITASDESC'] ?>"/></div>
                                                    </div>
