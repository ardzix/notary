...
/*
 * Project Name: notary
 * File Name: status_user_edit
 * Created on: 20 Jan 14 - 11:12:57
            ...
            <div class="body">
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Status Dokumen Edit</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Status User</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_status_dokumen">
                                                <input type="hidden" value="<?= $statusdokumen['IDSTATUSDOC'] ?>" NAME="IDSTATUSDOC">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status User:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="STATUS" value="<?= $statusdokumen['STATUS'] ?>"/></div>
                                                    </div>
