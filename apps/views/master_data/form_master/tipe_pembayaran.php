...
/*
 * Project Name: notary
 * File Name: tipe_pembayaran
 * Created on: 20 Jan 14 - 11:15:25
            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data tipe pembayaran berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data tipe pembayaran berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data tipe pembayaran gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Tipe Pembayaran</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li   class="active"><a href="<?= base_url() ?>master_data/form_master/tipe_pembayaran">Tipe Pembayaran</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Tipe Pembayaran Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/tipe_pembayaran">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Tipe Pembayaran:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="TIPEBYRIDDESC" placeholder="Masukan Tipe Pembayaran Baru"/></div>
                                                    </div>
                                            ...
                                            <div class="data-fluid">
                                                <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($tipepembayaran as $row):
                                                            ?>
                                                            <tr>
                                                                <td><input type="checkbox" name="order[]" value="528"/></td>
                                                                <td><?= $row->TIPEBYRIDDESC ?></td>
                                                                <td>
                                                                 
                                                                    <a href="<?= base_url() ?>master_data/form_master/tipe_pembayaran/edit/<?= $row->TIPEBYRID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->TIPEBYRID ?>')"> 
...
<script>
    function hapus(tipe_pembayaran) {
        document.getElementById('tipe_pembayaran').href = '<?= base_url() ?>control/delete/delete_tipe_pembayaran/' + tipe_pembayaran;
    }
</script>
</body>
</html>
