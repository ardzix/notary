...
/*
 * Project Name: notary
 * File Name: identitas_personal
 * Created on: 20 Jan 14 - 11:02:50
            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data identitas personal berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data identitas personal berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data identitas personal gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Identitas Personal</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li  class="active"><a href="<?= base_url() ?>master_data/form_master/identitas_personal">Identitas Personal</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Identitas Personal Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/identitaspersonal">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Identitas Pesonal:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="IDENTITASPERSONALDESC" placeholder="Masukan Identitas Personal Baru"/></div>
                                                    </div>
                                                ...
                                                <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="50%">Identitas Personal</th>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($identitaspersonal as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row->IDENTITASPERSONALDESC ?></td>
                                                                <td>
                                                                    <a href="<?= base_url() ?>master_data/form_master/identitas_personal/edit/<?= $row->IDENTITASPERSONALID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->IDENTITASPERSONALID ?>')"> 
...
<script>
    function hapus(identitas) {
        document.getElementById('identitas').href = '<?= base_url() ?>control/delete/delete_identitas_personal' + identitas;
    }
</script>
</body>
</html>
