...
/*
 * Project Name: notary
 * File Name: gender_edit
 * Created on: 20 Jan 14 - 10:27:04
                                ...
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_gender">
                                                <input type="hidden" value="<?= $gender['GENDER'] ?>" NAME="GENDER">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Gender:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="GENDERDESC" value="<?= $gender['GENDERDESC'] ?>"/></div>
                                                    </div>
