            ...
            <div class="body">
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Menu</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <!--<li  class="active"><a href="<?//= base_url() ?>master_data/form_master/menu">Menu</a></li>-->
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/menu">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Menu:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="MENUDESC" placeholder="Masukan Menu Baru"/></div>
                                                    </div>
<!--                                                    <div class="row-form">
                                                        <div class="span4">Level Menu:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="LEVELMENU" placeholder="Masukan Level Menu"/></div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">No Menu:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="NOURUTMENU" placeholder="Masukan No Menu"/></div>
                                                    </div>
                                                ...
                                                <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="75%">Menu</th>
<!--                                                            <th width="25%">Level Menu</th>
                                                            <th width="25%">No Menu</th>-->
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($menu as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row->MENUDESC ?></td>
<!--                                                                <td><?= $row->LEVELMENU ?></td>
                                                                <td><?= $row->NOURUTMENU ?></td>-->
                                                                <td>
                                                                 
                                                                    <a href="<?= base_url() ?>master_data/form_master/menu/edit/<?= $row->MENUID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->MENUID ?>')"> 
...
<script>
    function hapus(menu) {
        document.getElementById('menu').href = '<?= base_url() ?>control/delete/delete_menu/' + menu;
    }
</script>
</body>
</html>
