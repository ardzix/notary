...
/*
 * Project Name: notary
 * File Name: status_pajak_edit
 * Created on: 20 Jan 14 - 11:11:25
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Status Pajak</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_status_pajak">
                                                <input type="hidden" value="<?= $statuspajak['STATUSPJKID'] ?>" NAME="STATUSPJKID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status Pajak:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="STATUSPJKDESC" value="<?= $statuspajak['STATUSPJKDESC'] ?>"/></div>
                                                    </div>
