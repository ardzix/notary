...
/*
 * Project Name: notary
 * File Name: tipe_pembayaran_edit
 * Created on: 20 Jan 14 - 11:16:23
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Tipe Pembayaran</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_tipe_pembayaran">
                                                <input type="hidden" value="<?= $tipepembayaran['TIPEBYRID'] ?>" NAME="TIPEBYRID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Tipe Pembayaran:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="TIPEBYRIDDESC" value="<?= $tipepembayaran['TIPEBYRIDDESC'] ?>"/></div>
                                                    </div>
