            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data gender berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data gender berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data gender gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Gender</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Gender Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/gender">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Gender:</div>
                                                        <div class="span8"><input type="text" class="validate[required]" name="GENDERDESC" placeholder="Masukan Gender Baru"/></div>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($gender as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row->GENDERDESC ?></td>
                                                                <td>
                                                                    <!--                                                                <button class="btn tip" data-original-title="Default tip">Default tip</button>-->

                                                                    <a href="<?= base_url() ?>master_data/form_master/gender/edit/<?= $row->GENDER ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="modalToogler('<?= $row->GENDER ?>')"> 
...
<script>
    function modalToogler(gender){
        document.getElementById('gender').href="<?= base_url() ?>control/delete/delete_gender/" + gender;
    }
</script>
