...
/*
 * Project Name: notary
 * File Name: jabatan_edit
 * Created on: 20 Jan 14 - 11:02:20
                                ...
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_jabatan">
                                                <input type="hidden" value="<?= $jabatan['JABATANID'] ?>" NAME="JABATANID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Jabatan:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="JABATANDESC" value="<?= $jabatan['JABATANDESC'] ?>"/></div>
                                                    </div>
