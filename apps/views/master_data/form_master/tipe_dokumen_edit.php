...
/*
 * Project Name: notary
 * File Name: tipe_dokumen_edit
 * Created on: 20 Jan 14 - 11:18:02
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Tipe Dokumen</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_tipe_dokumen">
                                                <input type="hidden" value="<?= $tipedokumen['TIPEDOKUMENID'] ?>" NAME="TIPEDOKUMENID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Tipe Dokumen:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="TIPEDOKDESC" value="<?= $tipedokumen['TIPEDOKDESC'] ?>"/></div>
                                                    </div>
