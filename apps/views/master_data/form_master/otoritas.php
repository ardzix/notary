            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data otoritas berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data otoritas berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data otoritas gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Otoritas</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li   class="active"><a href="<?= base_url() ?>master_data/form_master/otoritas">Otoritas</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Otoritas Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/otoritas">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Otoritas:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="OTORITASDESC" placeholder="Masukan Otoritas Baru"/></div>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($otoritas as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row->OTORITASDESC ?></td>
                                                                <td>
                                                                 
                                                                    <a href="<?= base_url() ?>master_data/form_master/otoritas/edit/<?= $row->OTORITASID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->OTORITASID ?>')"> 
...
<script>
    function hapus(otoritas) {
        document.getElementById('otoritas').href = '<?= base_url() ?>control/delete/delete_otoritas/' + otoritas;
    }
</script>
</body>
</html>
