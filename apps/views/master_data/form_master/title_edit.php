...
/*
 * Project Name: notary
 * File Name: title_edit
 * Created on: 20 Jan 14 - 11:05:56
                                ...
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_title">
                                                <input type="hidden" value="<?= $title['TITLEID'] ?>" NAME="TITLEID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Title:</div>
                                                        <div class="span8"><input type="text" class="validate[required]" NAME="TITLEDESC" value="<?= $title['TITLEDESC'] ?>"/></div>
                                                    </div>
