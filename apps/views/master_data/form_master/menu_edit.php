                                ...
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                           ...
                                           <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_menu">
                                                <input type="hidden" value="<?= $menu['MENUID'] ?>" NAME="MENUID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Menu:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="MENUDESC" value="<?= $menu['MENUDESC'] ?>"/></div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Level:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="LEVELMENU" value="<?= $menu['LEVELMENU'] ?>"/></div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">No:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="NOURUTMENU" value="<?= $menu['NOURUTMENU'] ?>"/></div>
                                                    </div>
