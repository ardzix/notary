...
/*
 * Project Name: notary
 * File Name: tipe_wilayah_edit
 * Created on: 20 Jan 14 - 11:19:26
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Tipe Wilayah</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_tipe_wilayah">
                                                <input type="hidden" value="<?= $tipewilayah['TIPEWILAYAHID'] ?>" NAME="TIPEWILAYAHID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Tipe Wilayah:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="TIPEWILAYAHDESC" value="<?= $tipewilayah['TIPEWILAYAHDESC'] ?>"/></div>
                                                    </div>
