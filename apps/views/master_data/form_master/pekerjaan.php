            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data pekerjaan berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data pekerjaan berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data pekerjaan gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Pekerjaan</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li   class="active"><a href="<?= base_url() ?>master_data/form_master/pekerjaan">Pekerjaan</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Input Pekerjaan Baru</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/pekerjaan">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Pekerjaan:</div>
                                                        <div class="span8"><input type="text" class="validate[required]" name="PEKERJAANDESC" placeholder="Masukan p Baru"/></div>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($pekerjaan as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row->PEKERJAANDESC ?></td>
                                                                <td>
                                                                    <a href="<?= base_url() ?>master_data/form_master/pekerjaan/edit/<?= $row->PEKERJAANID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->PEKERJAANID ?>')"> 
...
<script>
    function hapus(pekerjaan){
     document.getElementById('pekerjaan').href= '<?= base_url() ?>control/delete/delete_pekerjaan/' + pekerjaan;   
    }
</script>
</body>
</html>