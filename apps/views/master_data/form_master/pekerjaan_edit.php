...
/*
 * Project Name: notary
 * File Name: pekerjaan_edit
 * Created on: 20 Jan 14 - 10:56:28
                                ...
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_pekerjaan">
                                                <input type="hidden" value="<?= $pekerjaan['PEKERJAANID'] ?>" NAME="PEKERJAANID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Pekerjaan:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="PEKERJAANDESC" value="<?= $pekerjaan['PEKERJAANDESC'] ?>" /></div>
                                                    </div>
