                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Satuan Waktu Standard</h2>                                
                                            </div>
                                            <form  id="validate" method="post" action="<?= base_url() ?>control/edit/edit_satuan_waktu_std">
                                                <input type="hidden" value="<?= $satuanwaktustd['SATWAKTUSTDID'] ?>" NAME="SATWAKTUSTDID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Satuan Waktu Standard:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="SATWAKTUDESC" value="<?= $satuanwaktustd['SATWAKTUDESC'] ?>"/></div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Konversi (/hari):</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="KONVERSI" value="<?= $satuanwaktustd['KONVERSI'] ?>"/></div>
                                                    </div>
