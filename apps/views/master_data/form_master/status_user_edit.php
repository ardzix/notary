            ...
            <div class="body">
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Status User Edit</small></h1>
                    </div>
                    <div class="row-fluid">
                                ...
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_status_user">
                                                <input type="hidden" value="<?= $statususer['STATUSUSERID'] ?>" NAME="STATUSUSERID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status User:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="STATUSUSERDESC" value="<?= $statususer['STATUSUSERDESC'] ?>"/></div>
                                                    </div>
