...
/*
 * Project Name: notary
 * File Name: identitas_personal_edit
 * Created on: 20 Jan 14 - 11:04:22
            ...
            <div class="body">
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Identitas Personal ID</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Identitas Personal</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_identitas_personal">
                                                <input type="hidden" value="<?= $identitaspersonal['IDENTITASPERSONALID'] ?>" NAME="IDENTITASPERSONALID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Identitas Personal:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="IDENTITASPERSONALDESC" value="<?= $identitaspersonal['IDENTITASPERSONALDESC'] ?>"/></div>
                                                    </div>
