            ...
            <div class="body">
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'success') {
                    ...
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data jabatan berhasil disimpan!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'update') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data jabatan berhasil diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                if (isset($_GET['message']) && $_GET['message'] == 'error') {
                    ?>
                    <div class="alert alert-success">            
                        <div align="center"><strong>[Pemberitahuan]</strong> Data jabatan gagal disimpan/diupdate!</div>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Form Master<small> Jabatan</small></h1>
                    </div>
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li  class="active"><a href="<?= base_url() ?>master_data/form_master/jabatan">Jabatan</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form id="validate" method="post" action="<?= base_url() ?>control/add/jabatan">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Jabatan:</div>
                                                        <div class="span8"><input type="text" class="validate[required]" name="JABATANDESC" placeholder="Masukan Gender Baru"/></div>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($jabatan as $row):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row->JABATANDESC ?></td>
                                                                <td>
                                                                    <!--                                                                <button class="btn tip" data-original-title="Default tip">Default tip</button>-->

                                                                    <a href="<?= base_url() ?>master_data/form_master/jabatan/edit/<?= $row->JABATANID ?>" class="button green tip" data-original-title="Edit">
                                                                        <div class="icon"><span class="ico-pencil"></span></div>
                                                                    </a>
                                                                    <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->JABATANID ?>')"> 
...
<div id="bModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
    ...
    function hapus(jabatan){
        document.getElementById('jabatan').href = '<?= base_url() ?>control/delete/delete_jabatan/' + jabatan;
    }
    </script>
</body>
</html>
