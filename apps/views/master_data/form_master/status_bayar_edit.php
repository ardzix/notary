...
/*
 * Project Name: notary
 * File Name: status_bayar_edit
 * Created on: 20 Jan 14 - 11:48:14
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            <div class="head">                                
                                                <h2>Edit Status Bayar</h2>                                
                                            </div>
                                            <form id="validate" method="post" action="<?= base_url() ?>control/edit/edit_status_bayar">
                                                <input type="hidden" value="<?= $statusbayar['STATUSBYR'] ?>" NAME="STATUSBYR">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Status Bayar:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="STATUSBYRDESC" value="<?= $statusbayar['STATUSBYRDESC'] ?>"/></div>
                                                    </div>
