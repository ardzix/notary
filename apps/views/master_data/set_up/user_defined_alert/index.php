...
/*
 * Project Name: notary
 * File Name: set_up_user_defined_alert
 * Created on: 08 Jan 14 - 11:18:38
            ...
            <div class="body">
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Set-up<small> Setup User Defined Alert</small></h1>
                    </div>
                    <div class="row-fluid">
                        ...
                        <div class="span12">                
                            <div class="block">
                                <div class="head dblue">
                                    ...
                                    <h2>Setup User Defined Alert</h2>
                                    <ul class="buttons">
                                    ...
                                    <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url() ?>master_data/set_up/user_defined_alert/pick/<?=$row->TRANSAKSIPRAID; ?>" class="button yellow tip" data-original-title="Pick">
