...
/*
 * Project Name: notary
 * File Name: bank_entry
 * Created on: 16 Jan 14 - 8:21:26
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active"><a href="<?= base_url() ?>master_data/financial_master/bank_info/bank_entry">Bank: Entry</a></li>
                                    ...
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <div class="data-fluid">
                                                <form id="validate" method="post" action="<?= base_url() ?>control/add/bank_entry">
                                                    <div class="row-form">
                                                        <div class="span4">Sebutan Bank:</div>
                                                        <div class="span8">
                                                            <select name="BANKUTAMAID" class="select">
                                                    ...
                                                    <div class="row-form">
                                                        <div class="span4">Deskripsi:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="BANKREKDESC" placeholder="Masukan Deskripsi Bank"/></div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Alamat:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" name="ALAMATBANKREK" placeholder="Masukan Alamat Bank"/></div>
                                                    </div>
