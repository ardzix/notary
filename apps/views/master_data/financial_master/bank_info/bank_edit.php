                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active"><a href="<?= base_url() ?>master_data/financial_master/bank_info/bank_edit">Bank: Edit</a></li>
                                        ...
                                        <div class="data-fluid">
                                            <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th width="10%">No</th>
                                                        <th width="20%">Bank Utama</th>
                                                        <th width="30%">Deskripsi Bank</th>
                                                        <th width="20%">Alamat Bank</th>
                                                ...
                                                <tbody>
                                                    <?php foreach ($bankrekening as $row):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $this->model_translate->dynamicTranslate('bankutama', 'BANKUTAMAID', $row->BANKUTAMAID, 'BANKUTAMADESC') ?></td>
                                                            <td><?= $row->BANKREKDESC ?></td>
                                                            <td><?= $row->ALAMATBANKREK ?></td>
                                                            <td>
                                                                <a href="<?= base_url() ?>master_data/financial_master/bank_info/bank_edit/edit_bank/<?= $row->BANKREKID ?>" class="button green tip" data-original-title="Edit">
                                                                    <div class="icon"><span class="ico-pencil"></span></div>
                                                                </a>
                                                                <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->BANKREKID ?>')"> 
...
<script>
    function hapus(bankrekid) {
        document.getElementById('bankrekid').href="<?= base_url() ?>control/delete/delete_bank_rekening/" + bankrekid;
    }
</script>
</body>
</html>