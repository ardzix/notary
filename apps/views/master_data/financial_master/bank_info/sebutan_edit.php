...
/*
 * Project Name: notary
 * File Name: sebutan_edit
 * Created on: 16 Jan 14 - 8:21:05
                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active"><a href="<?= base_url() ?>master_data/financial_master/bank_info/sebutan_edit">Sebutan Bank: Edit</a></li>
                                                ...
                                                <tbody>
                                                    <?php foreach ($bankutama as $row):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $row->BANKUTAMADESC ?></td>
                                                            <td>
                                                                <a href="<?= base_url() ?>master_data/financial_master/bank_info/sebutan_edit/edit_sebutan/<?= $row->BANKUTAMAID ?>" class="button green tip" data-original-title="Edit">
                                                                    <div class="icon"><span class="ico-pencil"></span></div>
                                                                </a>
                                                                <a href="#bModal" role="button" class="button red tip" data-original-title="Delete" data-toggle="modal" onclick="hapus('<?= $row->BANKUTAMAID ?>')"> 
...
<script>
    function hapus(bankutamaid){
        document.getElementById('bankutama').href="<?= base_url() ?>control/delete/delete_bank_utama/" + bankutamaid;
    }
</script>
</body>
</html>