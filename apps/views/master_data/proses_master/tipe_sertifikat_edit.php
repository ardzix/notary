            ...
            <div class="body">
                ...
                <div class="content">
                    ...
                    <div class="page-header">
                        ...
                        <h1>Proses Master<small> Tipe Sertifikat (Edit)</small></h1>
                    </div>
                    <div class="row-fluid">
                                ...
                                <div class="data-fluid tabbable">  
                                    <div class="span6">
                                        <div class="block">
                                            ...
                                            <form  id="validate" method="post" action="<?= base_url() ?>control/edit/tipe_sertifikat">
                                                <input type="hidden" value="<?= $tipesertifikat['TYPESERTIFIKATID'] ?>" NAME="TYPESERTIFIKATID">
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        <div class="span4">Tipe Sertifikat:</div>
                                                        <div class="span8"><input class="validate[required]" type="text" NAME="TYPESERTIFIKATDESC" value="<?= $tipesertifikat['TYPESERTIFIKATDESC'] ?>"/></div>
                                                    </div>
