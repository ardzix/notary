                        ...
                        <div class="block">
                            ...
                            <div class="data-fluid tabbable">                    
                                ...
                                <div class="tab-content">
                                    ...
                                    <form name="setupProses" id="validate" method="post" action="<?= base_url() ?>control/edit/setupProses/<?= $proses['PROSESID'] ?>">
                                        <div class="span6">                
                                            ...
                                            <div class="block">
                                                ...
                                                <div class="data-fluid">
                                                    <div class="row-form">
                                                        ...
                                                        <div class="span8">
                                                            <select name="SATWAKTUSTDID" class="select" >
                                                                <option value="<?= $proses['SATWAKTUSTDID'] ?>"><?php echo $this->model_translate->dynamicTranslate('satuanwaktustd', 'SATWAKTUSTDID', $proses['SATWAKTUSTDID'], 'SATWAKTUDESC'); ?></option>
                                                                <?php
                                                    ...
                                                    <div class="row-form">
                                                        ...
                                                        <div class="span8">
                                                            <input type="text" NAME="DEFWAKTUSTD" value="<?= $proses['DEFWAKTUSTD'] ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Proses:</div>
                                                        <div class="span8">
                                                            <input type="text" name="PROSESDESC" value="<?= $proses['PROSESDESC'] ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Kantor Proses:</div>
                                                        <div class="span8">
                                                            <select name="kantorprosesid" class="select" >
                                                                <option value="<?= $proses['KANTORPROSESID'] ?>"><?php echo $this->model_translate->dynamicTranslate('kantorproses', 'KANTORPROSESID', $proses['KANTORPROSESID'], 'KANTORPROSES'); ?></option>
                                                                <?php
                                            ...
                                            <div class="block">
                                                ...
                                                <div class="data-fluid">
                                                    ...
                                                    <div class="row-form">
                                                        ...
                                                        <div class="span8">
                                                            <select name="DEFSATALERT" class="select" >
                                                                <option value="<?= $proses['DEFSATALERT'] ?>"><?php echo $this->model_translate->dynamicTranslate('satuanwaktustd', 'SATWAKTUSTDID', $proses['DEFSATALERT'], 'SATWAKTUDESC'); ?></option>
                                                                <?php
                                                                foreach ($satuanwaktustd as $row):
                                                                    ?>
                                                                    <option value="<?= $row->SATWAKTUSTDID; ?>"><?= $row->SATWAKTUDESC; ?></option>
                                                    ...
                                                    <div class="row-form">
                                                        ...
                                                        <div class="span8">
                                                            <input type="text" NAME="DEFPICALERT" value="<?= $proses['DEFPICALERT'] ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Definisi Standard Alert Supervisor:</div>
                                                        <div class="span8">
                                                            <input type="text" NAME="DEFSPVALERT" value="<?= $proses['DEFSPVALERT'] ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Definisi Biaya Proses:</div>
                                                        <div class="span8">
                                                            <input type="text" NAME="DEFBIAYAPROSES" value="<?= $proses['DEFBIAYAPROSES'] ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="row-form">
                                                        <div class="span4">Definisi Biaya Drop:</div>
                                                        <div class="span8">
                                                            <input type="text" NAME="DEFBIAYADROP" value="<?= $proses['DEFBIAYADROP'] ?>"/>
                                                        </div>
                                                    </div>
