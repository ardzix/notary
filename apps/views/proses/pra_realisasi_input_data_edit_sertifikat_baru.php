                                    ...
                                    <div class="tab-content">
                                        <div class="span12">   
                                            <div class="data-fluid">
                                                <form name="praRealisasi" action="<?= base_url() ?>control/edit/sertifikat_baru" method="post">
                                                    <div class="row-fluid">

                                                        <div class="span12"> 
                                                            <div class="block">
                                                                <div class="head">                                
                                                                    <h2>Edit Sertifikat Baru</h2>
                                                                </div>                                        
                                                                <div class="data-fluid">
                                                                    ...
                                                                    <div class="row-form">
                                                                        ...
                                                                        <div class="span4">
                                                                            <input type="text" name="noSertifikat"> </div>
                                                                    </div>
                                                                    <div class="row-form">
                                                                        <div class="span2">Kelurahan/Desa:</div>
                                                                        <div class="span4">
                                                                            <input type="text" name="kelDesa"> </div>
                                                                    </div>
                                                                    <div class="row-form">
                                                                        <div class="span2">Kota/Kabupaten:</div>
                                                                        <div class="span4">
                                                                            <input type="text" name="kotaKab"> </div>
                                                                    </div>
                                                                    <div class="row-form">
                                                                        <div class="span2">Atas Nama:</div>
                                                                        <div class="span4">
                                                                            <input type="text" name="atsNama"> </div>
                                                                    </div>
                                                                    <div class="row-form">
                                                                        <div class="span2">Nama Penjual:</div>
                                                                        <div class="span4">
                                                                            <input type="text" name="penjual"> </div>
                                                                    </div>
                                                                    <div class="row-form">
                                                                        <div class="span2">Nama Pembeli:</div>
                                                                        <div class="span4">
                                                                            <input type="text" name="pembeli"> </div>
                                                                    </div>
