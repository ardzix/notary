...
<html lang="en">
    ...
    <body>    
                            ...
                            <div class="block">
                                <form method="POST" action="<?= base_url(); ?>proses/pasca_realisasi/monitoring_filter">
                                    <div class="data-fluid">
                                        ...
                                        <!--Form option for print/export-->
                                        <div class="row-form">
                                            <div class="span2">Print/Export:</div>
                                            <div class="span3">
                                                <input type="checkbox" name="withDone" id="withDone"> Print data done
                                            </div>
                                            <div class="span2">
                                                Ukuran kertas: 
                                            </div>
                                            <div class="span2">
                                                <?= form_dropdown('paperSize', array(0 => 'a4', 1 => 'a3'), '', 'id="paperSize"') ?> 
                                            </div>
                                            <div class="span1"><button class="btn" onclick="pagePrint('export')" type="button">Export</button></div>
                                            <div class="span1"><button class="btn" onclick="pagePrint('print')"type="button">Print</button></div>
                                        </div>
                                    </div>
                                </form> 
                            </div>
        ...
        <script>
            ...
            function pagePrint(arg) {
                var withDone = document.getElementById("withDone").checked;
                var paperSize = document.getElementById("paperSize").value;
                if(arg=="print"){
                    <?php if($this->uri->segment(3)=="monitoring_filter"){ ?>
                        window.open('<?=base_url() ?>proses/pasca_realisasi/monitoring_print_filter/'+'withDone='+withDone+'&paperSize='+paperSize+'<?= $filter ?>','_blank');
                    <?php }else{ ?>
