...
<html lang="en">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <div class="row-form">
                                    ...
                                    <div class="span9">
                                        <select class="select" id="employeeId" name="empId" >
    ...
    <div id="fModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><form name="jadwal" action="<?= base_url() ?>control/add/jadwal"  method="post">
