                    ...
                    <div class="row-fluid">
                            ...
                            <div class="block">
                                ...
                                <div class="data-fluid">
                                    ...
                                    <div class="row-form">
                                        ...
                                        <div class="span8"><input type="text" name="test" value="<?php $customer = $this->model_core->get_where_result('customertrans', array('TRANSAKSIPRAID' => $this->uri->segment(5)));
                        ...
                        <div class="span10">
                            ...
                            if ($dataTableDokumen == NULL) {
                                ?>
                                <div class="btn-group">
                                    <a href="<?= base_url() ?>proses/pra_realisasi/entry/detailTrans/<?= $this->uri->segment(5)?>" role="button"><button class="btn">Add</button></a>
                                </div><br>
