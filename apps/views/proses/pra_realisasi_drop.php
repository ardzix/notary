                                                        ...
                                                        <?php foreach ($dataTableTransaksipra as $row) { ?>       
                                                            <tr>
                                                                ...
                                                                <td><?
                                                                    ...
                                                                    ?></td>
                                                                <td>
                                                                    <a href="<?= base_url(); ?>proses/pra_realisasi/drop/proses/<?= $row->TRANSAKSIPRAID ?>" class="button yellow tip" data-original-title="Drop">
                                                                        <div class="icon"><span class="icon-trash icon-white"></span></div>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>  
