                            ...
                            <div class="block">
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active"><a href="<?= base_url() ?>proses/pembayaran/simulasi">Simulasi</a></li>
                                        <li><a href="<?= base_url() ?>proses/pembayaran/bayar">Bayar</a></li>
                                    ...
                                    <div class="span6">
                                        <div style="border: #000080 solid 1px;width: 515px; height: 48px; border-radius:5px;">
                                            <table>
                                                <tr>
                                                    <td><h5 style="margin-top: 3px;margin-left: 5px;">Tetapkan simulasi biaya proses APHT sebagai biaya?</h5></td>
