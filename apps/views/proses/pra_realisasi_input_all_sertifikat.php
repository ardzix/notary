                                    ...
                                    <div class="tab-content">
                                        <div class="span12">   
                                            <div class="data-fluid">
                                                <form name="praRealisasi" action="<?= base_url() ?>control/add/input_all/sertifikat/<?= $this->uri->segment(5) ?>" method="post">
                                                    <div class="row-fluid">
                                                            ...
                                                            <div class="block">
                                                                ...
                                                                <div class="data-fluid">
                                                                    ...
                                                                    <div class="row-form">
                                                                      ...
                                                                      <div class="row-form">
                                                                        <div class="span4">Nama Pembeli:</div>
                                                                        <div class="span8">
                                                                            <input type="text" id="noTran" name="NAMAPEMBELI">
                                                                            <span class="bottom">Silahkan masukan nama pembeli</span> </div>
                                                                    </div>
                                                                    <div class="row-form">
                                                ...
                                                <div class="span6">
                                                    <div class="toolbar bottom" align="center">
                                                        <div class="btn-group">
                                                            <a href="<?= base_url() ?>proses/pasca_realisasi?message=success"><button class="btn">Finish</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> 
