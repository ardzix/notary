                                    ...
                                    <div class="tab-content">
                                        <div class="span12">   
                                            <div class="data-fluid">
                                                <form name="praRealisasi" action="<?= base_url() ?>control/edit/covernote" method="post">
                                                    <div class="row-fluid">

                                                        <div class="span12"> 
                                                            <div class="block">
                                                                <div class="head">                                
                                                                    <h2>Edit Covernote</h2>
                                                                </div>                                        
                                                                <div class="data-fluid">
                                                                    <input type="hidden" name="covernoteId" value="<?= $this->uri->segment(5) ?>" />
                                                                    <div class="row-form">
                                                                        <div class="span2">No Covernote:</div>
                                                                        <div class="span4">
                                                                            <input type="text" value="<?= $covernote['NOCOVERNOTE']; ?>" name="noCovernote"> </div>
                                                                    </div>
                                                                    <div class="row-form">
                                                                        <div class="span2">Tanggal Akad:</div>
                                                                        <div class="span4">
                                                                            <input type="text" value="<?= date('d-m-Y', strtotime($covernote['TGLAKAD'])); ?>" name="tgl_akad" class="dp1" /></div>
                                                                    </div>
                                                                    <div class="row-form">
                                                                        <div class="span2">Jangka Waktu Covernote:</div>
                                                                        <div class="span4">
                                                                            <input type="text" value="<?= date('d-m-Y', strtotime($covernote['TGLSELESAI'])); ?>" name="dlncovernote" class="dp1" /> </div>  
                                                                    </div>
