                            ...
                            <div class="block">
                                ...
                                <div class="data-fluid tabbable">                    
                                    <ul class="nav nav-tabs">
                                        ...
                                        if ($menuid1 != 1) {
                                            ?>
                                           <li class="active"><a href="<?= base_url() ?>proses/pra_realisasi/validasi">Validasi Dokumen</a></li>
                                            <?php
                                        }
                                        ?>
                                        <!-----------------------------------------------------------
                                                        ...
                                                        <?php foreach ($dataTableTransaksipra as $row) { ?>       
                                                            <tr>
                                                                ...
                                                                <td><?
                                                                    ...
                                                                    ?></td>
                                                                <td>
                                                                    <a href="<?= base_url(); ?>proses/pra_realisasi/validasi/proses/<?= $row->TRANSAKSIPRAID ?>" class="button yellow tip jDialog_form_button" data-original-title="Pick">
