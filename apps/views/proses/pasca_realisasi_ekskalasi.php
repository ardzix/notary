                        ...
                        <div class="span12">
                            <div class="block">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    if ($menuid1 != 1) {
                                        ?>
                                        <li class="active"><a href="<?= base_url() ?>proses/pasca_realisasi/ekskalasi" >Ekskalasi</a></li>
                                        <?php
                                    }
                                    ?>
                                    <!-----------------------------------------------------------
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($transcover as $cn) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $customer = $this->model_core->get_where_result('covernote', array('TRANSAKSIPRAID' => $cn->TRANSAKSIPRAID));
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url() ?>proses/pasca_realisasi/ekskalasi/proses_ekskalasi/<?= $cn->TRANSAKSIPRAID ?>" class="button yellow tip" data-original-title="Pick">
