...
<script type='text/javascript' src='<?= NOTARY_ASSETS ?>js/plugins/maskedinput/jquery.maskedinput-1.3.min.js'></script>
...
<script>
    ...
    function bunyiNotif() {
        ...
        var sound1 = "<?= base_url(); ?>assets/sound/x.ogg";
        var sound2 = "<?= base_url(); ?>assets/sound/x.mp3";
